...
def getGText(): # Obtener Registros
    entriesText = [surPGEntry, surMGEntry, namesGEntry, ageGEntry]
    entriesOption = [genderGEntry, nationalityGEntry]
    entry = [entryT.get(0.0, "end-1c") for entryT in entriesText] + [entryO.get() for entryO in entriesOption]
    return entry
