...
class RegistroHumanitario:
    ...
    def getHText(self):
        ...
        entriesHCheck = [self.docVar1, self.docVar2, self.docVar3, self.docVar4, self.docVar5, self.docVar6,
                         self.idiomaVar1, self.idiomaVar2, self.idiomaVar3,
                         self.idiomaVar4, self.idiomaVar5, self.idiomaVar6, self.idiomaVar7,
                         self.serviciosVar1, self.serviciosVar2, self.serviciosVar3, self.serviciosVar4,
                         self.serviciosVar5, self.serviciosVar6, self.serviciosVar7, self.serviciosVar8,
                         self.serviciosVar9, self.serviciosVar10, self.serviciosVar11, self.serviciosVar12,
                         self.serviciosVar13, self.serviciosVar14]
        entriesHOption = [self.H1Entry, self.H6Entry, self.H7Entry,
                          self.H9Entry, self.H10Entry, self.H11Entry,
                          self.H15Entry, self.H18Entry, self.H19Entry,
                          self.H20Entry, self.H22Entry, self.H23Entry,
                          self.H24Entry, self.H25Entry, self.H26Entry,
                          self.H28Entry, self.H29Entry, self.H30Entry,
                          self.H31Entry, self.H33Entry, self.H34Entry,
                          self.H35Entry]
        entry = [entryT.get(0.0, "end-1c") for entryT in entriesHText] + [entryO.get() for entryO in entriesHCheck] + [entryO.get() for entryO in entriesHOption]
        return entry
